...
SET orig_assets_path="C:/Users/%USERNAME%/Google Drive/Sheeplosion/Repo Assets/"
REM The dp part refers to the directory this script is running in
SET dest_path="%~dp0/Assets/"
...
REM ROBOCOPY options are: /E Copy dir. including empty, /DCOPY:DAT Copy directory timestamps too, /XO Exclude older files, /IS Exclude same files, XA:H Exclude hidden files.
